...
@click.option('--number-conv-channels',  default=120, type=int, help='Number of hidden channels in the convolutional layers.')
...
@click.option('--polymer-type', default='monomers', help='Type of polymers in the input data.')
