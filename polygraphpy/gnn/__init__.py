...
- `trainer.py`: Handles the training and evaluation loops.
- `data_processing.py`: Manages the conversion of molecular data into
  graph representations suitable for the GNN.
"""